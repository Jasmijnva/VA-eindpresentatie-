...
fig9 = px.box(new_df, x='tsunami', y='MoonPhase.percent', color='continent', labels={"tsunami": "Tsunami", "Moon.height": "Hoogte van de maan"}, title='Verband tussen de stand van de maan tegenover het voorkomen van een tsunami')
