...
solar = pd.read_csv('C:\Users\jasmi\Documents\Minor\VA eindpresentatie\SolarSystemAndEarthquakes.csv')
df = pd.read_csv('C:\Users\jasmi\Documents\Minor\VA eindpresentatie\earthquake_data.csv')
